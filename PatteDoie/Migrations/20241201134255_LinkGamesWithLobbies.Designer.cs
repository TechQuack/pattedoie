...
namespace PatteDoie.Migrations
{
    ...
    [Migration("20241201134255_LinkGamesWithLobbies")]
    partial class LinkGamesWithLobbies
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PatteDoie.Models.Platform.Game", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("395bc859-4bae-45aa-9624-ac9150d7e818"),
                            MaxPlayers = 8,
                            MinPlayers = 2,
                            Name = "Scattergories"
                        },
                        new
                        {
                            Id = new Guid("7f45ba49-4cf4-44fb-b83a-f608a7c24179"),
                            MaxPlayers = 5,
                            MinPlayers = 1,
                            Name = "SpeedTyping"
                        });
